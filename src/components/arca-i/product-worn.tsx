...
export function ProductWorn() {
  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-2 gap-6 sm:grid-cols-3 sm:gap-10 lg:gap-14">
        {worn.columns.map((col, i) => (
          <div
            ...
            className="flex flex-col gap-6 will-change-transform sm:gap-10 lg:gap-14"
          >
            {col.map((img, j) => (
              <RevealPlate
                key={img.src}
